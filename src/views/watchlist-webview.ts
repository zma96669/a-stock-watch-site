...
<script nonce="${nonce}">
(() => { const vscode=acquireVsCodeApi(); let state=${initialState}; let structureKey=''; let modalAction; let holdingsCollapsed=false; const $=s=>document.querySelector(s); const search=$('#search');
