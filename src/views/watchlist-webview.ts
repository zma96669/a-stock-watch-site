...
<script nonce="${nonce}">
(() => { const vscode=acquireVsCodeApi(); let state={groups:[],entries:[],currentCode:void 0,snapshot:{quotes:{},stale:false}}; const $=s=>document.querySelector(s); const search=$('#search');
